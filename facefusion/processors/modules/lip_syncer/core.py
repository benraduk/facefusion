...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		facefusion.jobs.job_store.register_step_keys([ 'lip_syncer_model', 'lip_syncer_pure_motion', 'lip_syncer_weight' ])
...
def sync_lip(target_face : Face, source_voice_frame : AudioFrame, temp_vision_frame : VisionFrame) -> VisionFrame:
	...
	if has_pure_motion():
		crop_vision_frame, additional_masks = process_live_portrait_motion(target_face, source_voice_frame, crop_vision_frame, affine_matrix)
...
def process_live_portrait_motion(target_face : Face, source_voice_frame : AudioFrame, crop_vision_frame : VisionFrame, affine_matrix) -> Tuple[VisionFrame, List]:
	face_template_expression = extract_template_expression(source_voice_frame)
...
def extract_template_expression(source_voice_frame : AudioFrame) -> LivePortraitExpression:
